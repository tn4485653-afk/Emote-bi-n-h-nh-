...
async def animation_packet(bundle_id, K, V, region):
    """Gói tin kích hoạt động tác Animation (Múa)"""
...
async def bundle_packet_final(bundle_id, K, V, region):
    """Gói tin chốt mặc đồ chính thức"""
